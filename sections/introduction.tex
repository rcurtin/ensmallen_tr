...
optimization toolkits like SciPy, OR-Tools,
and {\tt fminsearch()} function in MATLAB~\cite{matlab_fminsearch}.

However, unlike many of the existing optimization toolkits,
the optimizers in {\tt ensmallen} are generic and flexible,
...
Lastly, the overall framework facilitates the implementation of new optimization techniques.
