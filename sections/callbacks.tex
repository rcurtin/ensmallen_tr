...
\TODO{the following description of bool true/false result has possible inconsistency with Appendix~\ref{sec:callback_details}}
...
\TODO{description of bool true/false result has possible inconsistency with Appendix~\ref{sec:callback_details}}
  }
