...
\vspace{1.5ex}
  {Ryan R. Curtin~{$^{1,*}$}, Marcus Edel~{$^{2,3,*}$}, Conrad
Sanderson~{$^{4,5}$}, Rahul Ganesh Prabhu~{$^{6}$}, Suryoday Basak~{$^{7}$},
Zhihao Lou~{$^{8}$}}
%% see note below
\vspace{1.5ex}
...
$^6$~Birla Institute of Technology and Science, Pilani, Pilani Campus, India\\
$^7$~Department of Computer Science and Engineering, The University of Texas at
Arlington, USA\\
$^8$~Epsilon, Chicago, USA\\
