...
The library provides a large set of pre-built optimizers,
...
This can aid in the quick implementation and prototyping of new algorithms.
Through C++ template metaprogramming, {\tt ensmallen} is able to provide support for arbitrary
